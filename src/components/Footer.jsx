  ...
  return (
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
        ...
        <div className='flex-[1.5] w-full flex flex-row justify-between flex-wram md:mt-0 mt-10'>
          {
      ...
      <div className='w-full felx justify-between items-center md:flex-row flex-col pr-6 border-t-[1px] border-t-[#3F3E45] '>
